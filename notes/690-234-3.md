# [[690,234,3]] — periodic bivariate-bicycle on Z_15 x Z_23
...
- `research/kit/css.py:verify_css` / `compute_k` -- CSS commutation holds, `k = 234` exactly (GF(2) rank), `n = 690`, max check weight 8 on X and 8 on Z.
...
HX, HZ = build_bb(l=15, m=23, A_terms=[(1,2), (4,0), (6,2), (9,0)], B_terms=[(1,12), (4,0), (6,12), (9,0)])
```
