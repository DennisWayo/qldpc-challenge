# [[696,236,3]] — periodic bivariate-bicycle on Z_6 x Z_58
...
- `research/kit/css.py:verify_css` / `compute_k` -- CSS commutation holds, `k = 236` exactly (GF(2) rank), `n = 696`, max check weight 8 on X and 8 on Z.
...
HX, HZ = build_bb(l=6, m=58, A_terms=[(0,0), (1,25), (3,25), (4,0)], B_terms=[(0,0), (1,12), (3,12), (4,0)])
```
