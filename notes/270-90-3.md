# [[270,90,3]] — periodic bivariate-bicycle on Z_9 x Z_15
...
- `research/kit/css.py:verify_css` / `compute_k` -- CSS commutation holds, `k = 90` exactly (GF(2) rank), `n = 270`, max check weight 6 on X and 6 on Z.
...
HX, HZ = build_bb(l=9, m=15, A_terms=[(0,0), (2,9), (5,4), (6,5)], B_terms=[(0,0), (6,5)])
```
