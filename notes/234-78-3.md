# [[234,78,3]] — periodic bivariate-bicycle on Z_9 x Z_13
...
- `research/kit/css.py:verify_css` / `compute_k` -- CSS commutation holds, `k = 78` exactly (GF(2) rank), `n = 234`, max check weight 6 on X and 6 on Z.
...
HX, HZ = build_bb(l=9, m=13, A_terms=[(0,0), (6,0)], B_terms=[(0,0), (2,2), (5,2), (6,0)])
```
