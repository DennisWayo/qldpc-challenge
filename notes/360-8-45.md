# [[360,8,45]]: distance revision of the board's [[360,8,48]] entry

## Revision history

[[360,8,45]] supersedes the board's [[360,8,48]] entry. The code, its checks,
its layout, and its original provenance are unchanged; only the distance claim is
corrected. A GPU random-information-set search (verify/ris_gpu.py, recover mode, 300,000,000 trials per side, seed 2031) exhibits a weight-48 X-logical and a weight-45 Z-logical, so the previous
witness-backed bound d <= 48 was overstated and the honest parameter set is
[[360,8,45]]. The headline falls from kd^2/n = 51.2 to 45.0. Each lighter
...
|---|---|---|---|---|---|
| X | 55 | 48 | 300,000,000 | 2031 | yes |
| Z | 48 | 45 | 300,000,000 | 2031 | yes |
