# [[504,36,8]] — periodic bivariate-bicycle on Z_18 x Z_14
...
- `research/kit/css.py:verify_css` / `compute_k` -- CSS commutation holds, `k = 36` exactly (GF(2) rank), `n = 504`, max check weight 6 on X and 6 on Z.
...
HX, HZ = build_bb(l=18, m=14, A_terms=[(0,0), (0,11), (7,2), (7,8)], B_terms=[(0,0), (0,1)])
```
