# [[240,30,6]] — periodic bivariate-bicycle on Z_8 x Z_15
...
- `research/kit/css.py:verify_css` / `compute_k` -- CSS commutation holds, `k = 30` exactly (GF(2) rank), `n = 240`, max check weight 6 on X and 6 on Z.
...
HX, HZ = build_bb(l=8, m=15, A_terms=[(0,0), (0,7), (2,7), (5,0)], B_terms=[(0,0), (1,0)])
```
