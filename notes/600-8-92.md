...
Rebuild the exact checks from `codes/600-8-92.json`; its X/Z support lists are the complete reproducible artifact. The construction is a bivariate bicycle on Z_15 x Z_20 with the listed 14-term A and 13-term B supports. The final witness search used 8,000 RIS trials.
