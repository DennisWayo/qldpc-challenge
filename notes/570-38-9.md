# [[570,38,9]] — periodic bivariate-bicycle on Z_19 x Z_15
...
- `research/kit/css.py:verify_css` / `compute_k` -- CSS commutation holds, `k = 38` exactly (GF(2) rank), `n = 570`, max check weight 6 on X and 6 on Z.
...
HX, HZ = build_bb(l=19, m=15, A_terms=[(0,0), (0,11), (7,2), (7,8)], B_terms=[(0,0), (0,1)])
```
