# [[248,62,4]] — periodic bivariate-bicycle on Z_4 x Z_31
...
- `research/kit/css.py:verify_css` / `compute_k` -- CSS commutation holds, `k = 62` exactly (GF(2) rank), `n = 248`, max check weight 6 on X and 6 on Z.
...
HX, HZ = build_bb(l=4, m=31, A_terms=[(0,0), (0,30), (2,0), (3,30)], B_terms=[(0,0), (1,0)])
```
